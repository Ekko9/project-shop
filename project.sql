...
INSERT INTO `category` VALUES ('3', '电器');
...
CREATE TABLE `product` (
  ...
  `market_price` double(32,0) DEFAULT NULL,
  `shop_price` double(32,0) DEFAULT NULL,
  `pimage` varchar(200) DEFAULT NULL,
  `pdate` varchar(36) DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('3aee1fb6870b4219882a929be8f9c33f', 'user', '123');
INSERT INTO `user` VALUES ('68e59965abd344c695d90721b11ad8d3', 'admin', '');
