...
<html>
	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr class="warning">
							 ...
							 <c:forEach  items="${order.list }"  var="li">
							<tr class="active">
								...
								<td width="15%">
									<span class="subtotal">￥${li.subtotal}</span>
								</td>
							</tr>
							</c:forEach>	
						</tbody>
			...
			<div>
				<hr/>
				<form id="orderForm" method="post" action="${pageContext.request.contextPath}/OrderServlet" class="form-horizontal" style="margin-top:5px;margin-left:150px;">
